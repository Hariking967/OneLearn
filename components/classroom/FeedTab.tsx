...
export function FeedTab({ classroomId, isTeacher, currentUserId }: Props) {
    ...
    return (
      <div style={{
        ...
        background: isAnnouncement
          ? 'linear-gradient(180deg, hsl(38 92% 50% / 0.06), hsl(38 92% 50% / 0.03))'
          : 'linear-gradient(180deg, rgba(21,21,29,0.75), rgba(15,15,21,0.75))',
        border: `1px solid ${isAnnouncement ? 'hsl(38 92% 50% / 0.2)' : 'var(--line)'}`,
        overflow: 'hidden',
        marginBottom: 10,
      }}>
      ...
      <div style={{ borderRadius: 12, background: 'linear-gradient(180deg, rgba(21,21,29,0.75), rgba(15,15,21,0.75))', border: '1px solid var(--line)', padding: 16, marginBottom: 20 }}>
        <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
          {isTeacher && (
            <button
              ...
              style={{ padding: '4px 10px', borderRadius: 7, fontSize: 11, cursor: 'pointer', background: postType === 'announcement' ? 'hsl(38 92% 50% / 0.15)' : 'none', border: postType === 'announcement' ? '1px solid hsl(38 92% 50% / 0.4)' : '1px solid var(--line)', color: postType === 'announcement' ? 'hsl(38 92% 65%)' : 'var(--mute)' }}
            >
              Announcement
            </button>
          )}
          <button
            ...
            style={{ padding: '4px 10px', borderRadius: 7, fontSize: 11, cursor: 'pointer', background: postType === 'discussion' ? 'oklch(0.42 0.18 295 / 0.15)' : 'none', border: postType === 'discussion' ? '1px solid oklch(0.42 0.18 295 / 0.3)' : '1px solid var(--line)', color: postType === 'discussion' ? 'var(--purple-2)' : 'var(--mute)' }}
          >
            Discussion
          </button>
        </div>
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <textarea
            ...
            placeholder={postType === 'announcement' ? 'Write an announcement…' : 'Start a discussion…'}
            rows={3}
